...
export const metadata = {
  title: "Duwon Woningonderhoud — Vakkundig onderhoud & renovatie",
  description: "Duwon Woningonderhoud verzorgt professioneel schilderwerk, timmerwerk, tegelwerk en renovaties voor huiseigenaren in Nederland. Betrouwbaar, vakkundig en persoonlijk.",
};
